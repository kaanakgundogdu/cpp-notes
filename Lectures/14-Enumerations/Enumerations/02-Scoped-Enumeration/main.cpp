...
void test1() {
	std::cout << "\n--------- Scoped enumeration to model grocery items ---------\n" << std::endl;
    ...
    //shopping_list.push_back(Helicopter);// Compiler error
 	std::cout << "\n--------- Adding invalid item ---------" << std::endl;
	shopping_list.push_back(Grocery_Item(Helicopter));  
 	std::cout << "\n--------- Adding milk -> Grocery_Item(350) ---------" << std::endl;
...
void test2() {
   	std::cout << "\n------ Player has a name, a mode that they are currently in, and a direction ------\n" << std::endl;

    Player p1{"Cecil Harvey", Player::Mode::Attack, Player::Direction::North};
    Player p2{"Kain Highwind", Player::Mode::Defense, Player::Direction::West};
    Player p3{"Zeromus", Player::Mode::Idle, Player::Direction::South};
