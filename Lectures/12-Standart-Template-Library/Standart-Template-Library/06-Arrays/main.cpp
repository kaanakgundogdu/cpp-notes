...
void test1() {
    ...
    arr1[0] = 1000; // no bounds check
    arr1.at(1) = 2000; // bounds check
    display(arr1);
...
void test6() {
    std::cout << "\n-------------------Same elements or Adjacent----------------------" << std::endl;
