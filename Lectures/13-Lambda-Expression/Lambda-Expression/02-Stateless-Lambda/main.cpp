...
void test1() {
    std::cout << "\n-------------- Lambda function and calls --------------" << std::endl;
...
void test2() {
    std::cout << "\n-------------- values and references as lambda parameters --------------" << std::endl;
...
void test3() {
    std::cout << "\n-------------- value and reference objects as lambda parameters --------------" << std::endl;
    Person stooge {"Saka", 18};
...
void test4() {
    std::cout << "\n-------------- passing a lambda to a function --------------" << std::endl;
...
void test5() {
    std::cout << "\n-------------- returning a lambda from a function --------------" << std::endl;
...
void test6() {
    std::cout << "\n-------------- using auto in the lambda parameter --------------" << std::endl;
    ...
    l6 (Person("Celi", 18), Person("Hiho", 22));
}


void test7() {
    std::cout << "\n-------------- std::sort and std::for_each with lambda --------------" << std::endl;
