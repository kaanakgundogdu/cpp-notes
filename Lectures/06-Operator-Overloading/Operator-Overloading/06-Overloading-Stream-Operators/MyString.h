...
class MyString
{
    friend std::ostream &operator<<(std::ostream &os,const MyString &righths);
    friend std::istream &operator>>(std::istream &in,MyString &righths);
    friend bool operator==(const MyString &lefths, const MyString &righths);
private:
